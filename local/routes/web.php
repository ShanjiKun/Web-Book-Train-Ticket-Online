...
Route::group(['middleware' => ["App\Http\Middleware\CheckLevel"]], function(){
	...
	Route::get('admin-refund', ['as' => 'getAdminRefund', 'uses' => 'PaymentController@getAdminRefund']);
	Route::post('admin-refund', ['as' => 'postAdminRefund', 'uses' => 'PaymentController@postAdminRefund']);

	Route::get('admin-refund-success', ['as' => 'getAdminRefundSuccess', 'uses' => 'PaymentController@getAdminRefundSuccess']);
});
...
Route::post('sign-up',['as' => 'postSignUp','uses' => 'LoginController@postSignUp']);
