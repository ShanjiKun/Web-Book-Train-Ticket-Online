 	...
 	<div class="row"> 
  		<div class="col-xs-12 col-sm-12 col-md-4 well well-sm col-md-offset-4"> 
	   		...
	   		<form action="" method="post" class="frmSignUp" role="form">  
		    	...
		    	<label class="radio-inline"><input name="sex" id="inlineCheckbox1" value="male" type="radio">Male </label> 
		    	<label class="radio-inline"><input name="sex" id="inlineCheckbox2" value="female" type="radio">Female</label> 
		    	<br> 
		    	<br> 
